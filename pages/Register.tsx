...
import { register, loginWithGoogle, isAdmin } from '../auth';
...
const Register = (): React.ReactNode => {
    ...
    const handleGoogleLogin = async () => {
        ...
        if (await loginWithGoogle()) {
            ...
            setError('Error al registrarse con Google. Por favor, intente de nuevo.');
        }
        setLoading(false);
    };
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-lg">
                ...
                >
                    ...
                    {loading ? 'Creando cuenta...' : 'Crear cuenta con Google'}
                </button>
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-white text-gray-500">O crear cuenta con email</span>
                    </div>
                </div>
